    ...
    <div class="bg-dark test-question-container w-100">
      <div class="card-body p-0">
        ...
        <div class="d-flex justify-content-end" id="confirmBlock">
          <button onclick="navigator.vibrate?.(30)" class="btn btn-primary px-4 fw-semibold Wadaptive" id="btnConfirmAnswer">
            Подтвердить выбор
          </button>
        </div>
        ...
        <div class="d-flex justify-content-end d-none" id="nextQuestionBlock">
          <button onclick="navigator.vibrate?.(30)" class="btn btn-primary px-4 d-inline-flex align-items-center fw-semibold Wadaptive justify-content-center" id="btnNextQuestion">
            <span>Дальше</span>
